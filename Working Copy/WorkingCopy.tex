	...
	\subsection{Process specifications}
		...
		\newline		 
		 ...
		 \newline
		  ...
		  \includegraphics[scale=0.45]{createTact}
		 \newline
		 
		  \includegraphics[scale=0.45]{editTact}
		 \newline
		 
		  \includegraphics[scale=0.45]{deleteTact}
		 \newline
		 
		  \includegraphics[scale=0.45]{createPact}
		 \newline
		 
		  \includegraphics[scale=0.45]{editPact}
		 \newline
		 
		  \includegraphics[scale=0.45]{deletePact}
		 \newline
		 
		  \includegraphics[scale=0.45]{requestact}
		 \newline
